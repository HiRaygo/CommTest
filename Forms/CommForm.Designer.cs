...
namespace CommTest.Forms
{
	partial class CommForm
	{
		...
		private void InitializeComponent()
		{
			...
			// tBtimeout
			// 
			this.tBtimeout.Location = new System.Drawing.Point(68, 158);
			...
			this.cBportname.Items.AddRange(new object[] {
									...
									"COM19",
									"COM20"});
			this.cBportname.Location = new System.Drawing.Point(68, 23);
			...
			this.cBparity.Items.AddRange(new object[] {
									...
									"Even",
									"Mark"});
			this.cBparity.Location = new System.Drawing.Point(68, 131);
			...
			this.cBstopbits.Items.AddRange(new object[] {
									...
									"1.5",
									"2"});
			this.cBstopbits.Location = new System.Drawing.Point(68, 104);
			...
			this.cBdatabits.Items.AddRange(new object[] {
									...
									"7",
									"6"});
			this.cBdatabits.Location = new System.Drawing.Point(68, 77);
			...
			this.cBbaudrate.Items.AddRange(new object[] {
									...
									"76800",
									"115200"});
			this.cBbaudrate.Location = new System.Drawing.Point(68, 50);
			...
			// buttonOpenport
			// 
			this.buttonOpenport.Location = new System.Drawing.Point(7, 190);
